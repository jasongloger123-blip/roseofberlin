...
export default function Home() {
  ...
  return <main>
    ...
    <section id="start" className="hero"><div className="hero-copy"><p className="eyebrow">{t.origin}</p><h1>{t.hero}</h1><p className="intro">{t.intro}</p><div className="hero-actions"><a className="button primary" href="#bestellen">{t.select}</a><a className="text-link" href="#handwerk">{t.story} <span>↓</span></a></div></div><figure className="hero-visual"><img src="/rose-of-berlin-hero.jpeg" alt="Rose of Berlin Eau de Parfum surrounded by pink roses" /><figcaption>Red Rose · Selected by Selesitina</figcaption></figure></section>
